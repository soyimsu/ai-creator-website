    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-warm-100 via-pink-50 to-warm-50 py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <Link
            href="/tutorials"
            className="inline-block px-6 py-3 bg-warm-500 text-white rounded-full font-medium hover:bg-warm-600 transition-colors"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {resources.map((resource) => (
              <a
                ...
                className="bg-white rounded-2xl border border-warm-100 p-6 hover:shadow-lg transition-shadow group"
              >
